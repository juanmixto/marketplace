...
const en: Record<TranslationKeys, string> = {
  ...
  'vendor.productsOne': 'product',
  'vendor.productsOther': 'products',
  'vendor.rejectionReason': 'Reason',
  'vendor.alertExpired': 'removed due to expiration',
  'vendor.alertExpiredPlural': 'removed due to expiration',
  'vendor.alertOutOfStock': 'out of stock',
  'vendor.alertLowStock': 'Low stock',
  'vendor.status.draft': 'Draft',
  'vendor.status.pendingReview': 'In review',
  'vendor.status.active': 'Active',
  'vendor.status.rejected': 'Rejected',
  'vendor.status.suspended': 'Suspended',
  'vendor.filters.searchPlaceholder': 'Search by name…',
  'vendor.filters.status': 'Status',
  'vendor.filters.allStatuses': 'All',
  'vendor.filters.category': 'Category',
  'vendor.filters.allCategories': 'All',
  'vendor.filters.stock': 'Stock',
  'vendor.filters.stockAll': 'All',
  'vendor.filters.stockLow': 'Low',
  'vendor.filters.stockOut': 'Out',
  'vendor.filters.clear': 'Clear filters',
  'vendor.filters.noResults': 'No products match the filters',
