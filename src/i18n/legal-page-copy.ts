    ...
    privacy: {
      ...
      sections: {
        ...
        rights: {
          ...
          footnote: 'Si tienes sesión iniciada, puedes ejercer los derechos de acceso (descarga de datos) y supresión desde esta misma página. Para el resto, escríbenos por el formulario de contacto.',
        },
        retention: {
        ...
        contact: {
          ...
          accountNote: 'Si tienes sesión iniciada, en la sección "Tus derechos" de esta página puedes descargar tus datos o solicitar la eliminación de tu cuenta.',
        },
    ...
    privacy: {
      ...
      sections: {
        ...
        rights: {
          ...
          footnote: 'If you are signed in, you can exercise the rights of access (data download) and erasure from this page. For the rest, write to us via the contact form.',
        },
        retention: {
        ...
        contact: {
          ...
          accountNote: 'If you are signed in, the "Your rights" section of this page lets you download your data or request account deletion.',
        },
