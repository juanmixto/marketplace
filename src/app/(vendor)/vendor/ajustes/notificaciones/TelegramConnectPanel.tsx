    ...
    return (
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="font-medium text-[var(--foreground)]">{t('vendor.telegram.title')}</span>
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3">
      <div className="min-w-0">
        <div className="font-medium text-[var(--foreground)]">{t('vendor.telegram.title')}</div>
        <p className="text-sm text-[var(--muted)]">
          {waitingForLink
            ? t('vendor.telegram.waitingForLink')
            : t('vendor.telegram.subtitle')}
        </p>
      </div>
      {linkUrl ? (
        <a
