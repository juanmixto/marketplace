...
async function main() {
  ...
  // #1285 + #1223: nightly cleanup of expired ephemeral state (auth
  // tokens past expiresAt, synthetic-monitor orders > 24h). Same
  // registration ordering as DLQ — handler first, schedule second,
  // so the first tick lands on a registered worker.
